...
static const char col_gray1[]    = "#0B1015"; // charcoal void
static const char col_gray2[]    = "#0F6E82"; // teal supernova accent
static const char col_gray3[]    = "#E8F4F4"; // silver-white text
static const char col_selborder[]= "#0E6B6B"; // deep cyan border

static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_gray3, col_gray1, col_gray2},
    [SchemeSel] = {col_gray1, col_gray2, col_selborder},
};
...
static const Key keys[] = {
    ...
    {0, XK_F4, spawn,
     SHCMD("flameshot gui -p ~/media/pictures/screenshots -c")},
